...
const key = {
    headers: {
        "x-apikey": "6151ddb6dfa7346e2f9690b9"
    }
};
...
function showData(obj) {
    ...
    clone.querySelector(".imgforgrid").src = `https://neurotive.com/KEA/Golden_Ratio/louisiana_archivephotos_golden-ratio/fraTMS_3077.jpg`;
