...
const url = `https://keadata-ece4.restdb.io/rest/golden-ratio-database?sort=artist&q={"$distinct": "artist"}`;
...
function showArtists(art) {
  ...
  clone.querySelector(".artist-name").textContent = art;
  clone
    .querySelector(".artist-link")
    .setAttribute("href", "artist.html?artist=" + art);
